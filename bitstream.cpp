...
void TBitstream::skipBits(unsigned int num)
{
  if (m_doEP3)
  {
...
unsigned int TBitstream::readBits(int num)
{
  unsigned int r = 0;
...
unsigned int TBitstream::showBits(int num)
{
  unsigned int r = 0;
...
unsigned int TBitstream::readGolombUE(int maxbits)
{
  int lzb = -1;
  int bits = 0;
...
signed int TBitstream::readGolombSE()
{
  int v, pos;
  v = readGolombUE();
  if(v == 0)
